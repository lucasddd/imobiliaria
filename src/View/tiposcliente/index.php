...
<div class="col-md-12">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<input id="pesquisacateg" onkeyup="searchCateg(this.value)" type="text" class="form-control" name="busca" maxlength="50"  placeholder="Pesquisa" autofocus>
			</form>
		</div>
	</div>
	<div class="table-responsive">
		...
		<span id ="detalhescateg" class="">Total de: {{tipoclientes|length}} registro(s).</span>
	</div>
